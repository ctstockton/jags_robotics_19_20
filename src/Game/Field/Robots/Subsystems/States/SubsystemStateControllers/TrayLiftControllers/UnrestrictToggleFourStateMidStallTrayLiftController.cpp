#include "UnrestrictToggleFourStateMidStallTrayLiftController.h"

UnrestrictToggleFourStateMidStallTrayLiftController::UnrestrictToggleFourStateMidStallTrayLiftController(void)
{}

UnrestrictToggleFourStateMidStallTrayLiftController::UnrestrictToggleFourStateMidStallTrayLiftController(pros::Motor* motor, int upper, pros::controller_digital_e_t raise, pros::controller_digital_e_t lower, pros::controller_digital_e_t util1, pros::controller_digital_e_t util2):
...
void UnrestrictToggleFourStateMidStallTrayLiftController::obey(pros::Controller master)
{
