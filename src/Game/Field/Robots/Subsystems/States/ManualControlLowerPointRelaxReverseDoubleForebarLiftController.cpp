...
ManualControlLowerPointRelaxReverseDoubleForebarLiftController::ManualControlLowerPointRelaxReverseDoubleForebarLiftController(void)
{}

ManualControlLowerPointRelaxReverseDoubleForebarLiftController::ManualControlLowerPointRelaxReverseDoubleForebarLiftController(pros::Motor* left, pros::Motor* right, int relaxLimit, int raiseSpeed, int lowerSpeed, pros::controller_digital_e_t up, pros::controller_digital_e_t down):
...
void ManualControlLowerPointRelaxReverseDoubleForebarLiftController::obey(pros::Controller master)
{
